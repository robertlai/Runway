...
homeApp = angular.module('homeApp', ['ui.router', 'ui.router.title']).config([
  ...
  '$rootScope', '$scope', '$state', '$stateParams', '$http', function(rootScope, scope, state, stateParams, http) {
    return rootScope.editHeader = 'Edit Owned Group: ' + stateParams.groupName;
  }
]).controller('editJoinedController', [
  '$rootScope', '$scope', '$state', '$stateParams', '$http', function(rootScope, scope, state, stateParams, http) {
    return rootScope.editHeader = 'Edit Joined Group: ' + stateParams.groupName;
  }
]);

...
var app, bodyParser, cookieParser, express, favicon, flash, fs, http, io, ip, logger, mongoose, passport, port, router, session;
...
mongoose.connect(process.env.dbAddress != null ? process.env.dbAddress : require('./dbcredentials.json').dbAddress);
